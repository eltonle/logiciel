 ...
 <div class="card">
    <div class=" mt-2">
        <div class="d-flex justify-content-between items-center">
            <h5 class="text-lg">products Details</h5>
            <a href="{{ route('products.create') }}" class="btn btn-primary"> <i class="nav-icon fas fa-plus"></i> Add product</a>
        </div>
                    ...
                    <table id="example2" class="table table-bordered dataTable dtr-inline"
                        ...
                        <thead>
                            <tr>
                                <th class="sorting sorting_asc" tabindex="0" aria-controls="example2" rowspan="1"
                                    ...
                                    aria-label="Rendering engine: activate to sort column descending">Category
                                </th>
                                <th class="sorting sorting_asc" tabindex="0" aria-controls="example2" rowspan="1"
                                    colspan="1" aria-sort="ascending"
                        ...
                        <tbody>
                            ...
                            <tr class="odd">
                                ...
                                <td>{{ $product->name }}</td>
                                <td><img src="{{ Storage::url($product->image) }}" width="50" height="50" alt=""></td>
                                <td>{{ $product->price }}</td>
